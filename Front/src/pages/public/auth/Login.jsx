                        ...
                        <form className='w-full max-w-[480px] mx-auto flex flex-col gap-4' onSubmit={handleSubmit} noValidate>
                            <div className='flex flex-col items-start'>
                                ...
                                <input
                                    ...
                                    className={`self-stretch rounded-xl bg-[#f7fafc] border-solid border-[1px] box-border h-12 md:h-14 p-3 md:p-[15px] text-[#4f7a96] text-base md:text-lg ${fieldErrors.email ? 'border-red-500' : 'border-[#d1dee8]'}`}
                            ...
                            <div className='flex flex-col items-start relative'>
                                ...
                                <input
                                    ...
                                    value={form.password}
                                    onChange={handleChange}
                                    className={`self-stretch rounded-xl bg-[#f7fafc] border-solid border-[1px] box-border h-12 md:h-14 p-3 md:p-[15px] text-[#4f7a96] text-base md:text-lg pr-12 ${fieldErrors.password ? 'border-red-500' : 'border-[#d1dee8]'}`}
