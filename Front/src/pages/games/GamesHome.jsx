		...
		games: [
			{
				...
				path: '/games/vocabulary/tense-master',
				enable: true,
			},
			{
				...
				path: '/games/vocabulary/article-adventure',
				enable: false,
			},
			{
				...
				path: '/games/vocabulary/preposition-puzzle',
				enable: true,
			},
		],
	},
		...
		games: [
			{
				...
				src: '/depth-7-frame-01@2x.png',
				path: '/games/speak/pronunciation-practice',
				enable: true,
			},
			{
				title: 'Role Play',
			...
			},
			{
				...
				src: '/depth-7-frame-03@2x.png',
				path: '/games/speak/fluency-builder',
				enable: true,
			},
		],
	},
