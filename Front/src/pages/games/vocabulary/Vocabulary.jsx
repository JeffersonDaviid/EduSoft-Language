...
const vocabularyWords = [
    ...
    { definition: "An area of land that has its own government, army, etc.", answer: "country" },
    { definition: "To find an answer to a problem.", answer: "solve" },
    { definition: "A journey in which you go somewhere, usually for a short time, and come back again.", answer: "trip" },
    ...
    { definition: "Able to be easily hurt, influenced, or attacked.", answer: "vulnerable" },
    { definition: "The scientific study of the mind and how it influences behaviour.", answer: "psychology" },
    { definition: "A substance that is used to treat or prevent disease or pain.", answer: "medicine" }
];
    ...
    return (
        <div className="w-full max-w-2xl mx-auto my-16 bg-white shadow-2xl rounded-2xl p-6 sm:p-10 text-center">
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-xl sm:text-2xl font-bold text-blue-600">Vocabulary Challenge</h1>
